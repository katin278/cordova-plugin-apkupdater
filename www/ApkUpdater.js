...
module.exports = {
  ...
  requestPermissions: function (success, failure) {
    if (success == null && failure == null) {
      ...
      API.requestPermissions().then(success).catch(failure);
    }
  },
   ...
   * @returns {Promise<void>|void}
   */
  rebootDevice: function (success, failure) {
    if (success == null && failure == null) {
      return API.rebootDevice();
    } else {
      API.rebootDevice().then(success).catch(failure);
    }
  },
};
