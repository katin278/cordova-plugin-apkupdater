...
var ApkUpdater = /** @class */ (function () {
  ...
  ApkUpdater.requestPermissions = function () {
    var apkUpdater = plugin();
    return apkUpdater.requestPermissions.apply(apkUpdater, arguments);
  };
  ApkUpdater.rebootDevice = function () {
    var apkUpdater = plugin();
    return apkUpdater.rebootDevice.apply(apkUpdater, arguments);
  };
  return ApkUpdater;
}());
